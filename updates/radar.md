...
## 2026-08-19 — SDK 0.128.0–0.133.0 new; dlt and dbt-databricks unchanged

**dlt** — **1.30.0** (2026-08-11) unchanged. No new release since last check; no example
...
**Databricks** — Six new SDK releases between 2026-08-13 and 2026-08-19: **v0.128.0–v0.133.0**.
Highlights: IAM v2 account/workspace methods (0.128.0), pipeline channel + IAM list pagination
(0.129.0), LinkedIn Ads/Marketo connector options (0.130.0), bundle deployment operation field
changes (0.131.0), Apps git-source + ML custom_udf + Pipelines effective serverless compute
(0.132.0), serving telemetry features (0.133.0). All remain out of reach under the `<0.118.0`
